...
export const games: Game[] = [
  ...
  },
  {
    id: 'gem-miner',
    title: 'Gem Miner',
    description: 'Dig deep into the earth in this gem-matching puzzle! Swap and match colorful gems to clear levels, break through rocks and ice, and use powerful mining tools. 15 levels of increasing depth and difficulty await!',
    thumbnail: 'https://images.unsplash.com/photo-1551650975-87deedd944c3?w=400&h=300&fit=crop',
    category: 'puzzle',
    tags: ['match-3', 'puzzle', 'gems', 'mining', 'strategy'],
    playCount: 0,
    rating: 5.0,
    featured: true,
    createdAt: '2025-01-31',
    difficulty: 'medium',
    playUrl: '/play/gem-miner',
  },
  {
    id: 'creatures-of-the-night',
    title: 'Creatures of the Night',
    description: 'A gothic TCG idle game! Summon supernatural creatures, place them in your Crypt to generate Shadow Essence, open card packs, level up your collection, and send cards on expeditions. Features 12 creature types across 5 tiers with powerful synergies.',
    thumbnail: 'https://images.unsplash.com/photo-1509557965875-b88c97052f0e?w=400&h=300&fit=crop',
    category: 'idle',
    tags: ['tcg', 'idle', 'cards', 'gothic', 'collection', 'supernatural'],
    playCount: 0,
    rating: 5.0,
    featured: true,
    createdAt: '2026-02-07',
    difficulty: 'medium',
    playUrl: '/play/creatures-of-the-night',
  },
  {
    id: 'capitalism-sim',
